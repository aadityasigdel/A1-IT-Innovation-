      ...
      {isMobileView && mobileOpen && (
        <div className="fixed inset-0 z-50 flex">
          ...
          <div className="relative ml-auto w-80 max-w-full h-full bg-white shadow-2xl flex flex-col">
            ...
            {/* Social icons */}
            <div className="px-5 py-4 border-t border-gray-100 flex gap-3 justify-center flex-shrink-0 flex-wrap">
              <a href="https://www.facebook.com/a1itinnovationnepal" target="_blank" rel="me noopener noreferrer" aria-label="Facebook"
                className="w-9 h-9 rounded-full bg-gray-100 hover:bg-blue-100 hover:text-blue-700 flex items-center justify-center transition-colors">
              ...
              <a href="https://www.linkedin.com/company/a1itinnovation/" target="_blank" rel="me noopener noreferrer" aria-label="LinkedIn"
                className="w-9 h-9 rounded-full bg-gray-100 hover:bg-blue-100 hover:text-blue-800 flex items-center justify-center transition-colors">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://www.tiktok.com/@a1itinnovation" target="_blank" rel="me noopener noreferrer" aria-label="TikTok"
                className="w-9 h-9 rounded-full bg-gray-100 hover:bg-gray-200 hover:text-gray-900 flex items-center justify-center transition-colors">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://wa.me/9779816032025" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp"
                className="w-9 h-9 rounded-full bg-gray-100 hover:bg-green-100 hover:text-green-700 flex items-center justify-center transition-colors">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
