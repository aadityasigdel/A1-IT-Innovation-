...
// Service data array with matching icons
const services = [
  {
    title: "Web Development",
    description: "We create fast, responsive, and secure websites that deliver performance and user satisfaction.",
    icon: (
      <svg className="text-blue-500" height="50" width="50" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
  ...
  },
  {
    ...
    icon: (
      <svg className="text-green-500" height="50" width="50" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
  ...
  },
  {
    ...
    icon: (
      <svg className="text-red-500" height="50" width="50" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
  ...
  },
  {
    ...
    icon: (
      <svg className="text-yellow-500" height="50" width="50" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
  ...
  },
  {
    ...
    icon: (
      <svg className="text-purple-500" height="50" width="50" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            ...
            <div className="flex flex-col lg:flex-row items-center gap-12">
              <div className="lg:w-1/2 text-center lg:text-left">
                <h1 className="text-4xl md:text-5xl font-bold mb-4 text-gray-900">
                  Your One Stop <span className="text-indigo-600 block md:inline">IT Solution 🖥️</span>
                </h1>
