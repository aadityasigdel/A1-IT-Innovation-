        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              As a leading mobile app development company in Nepal, we create custom apps tailored to your needs, 
              handling everything from ideation to app store submission using agile methodologies.
            </p>
          </div>
