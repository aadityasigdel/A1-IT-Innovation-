      ...
      <main className="min-h-screen bg-gradient-to-b from-gray-50 to-white py-16">
        <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-20 text-center">
            ...
            <button className="bg-indigo-600 hover:bg-indigo-700 text-white font-medium py-2.5 px-8 rounded-lg transition-colors duration-300 inline-flex items-center">
              Explore Careers
